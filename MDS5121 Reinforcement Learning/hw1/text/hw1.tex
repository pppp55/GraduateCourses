...
\begin{enumerate}
    ...
    \end{gather}
    Thus, in this case, $\forall \gamma \in \left [0, 1 \right )$ and $q \in [0,1], \pi^*(s_0) = a_2$ % chktex 9
...
\begin{enumerate}
    ...
    \begin{gather}
        ...
        \end{cases}
    \end{gather}
    \item  With an MDP $\mathcal M = <S, s_0, A, C, P>$ with discount factor $\gamma \in [0, 1)$, we can construct an SSP $\mathcal S = <S', s_0, G, A, C', P'>$ as follows: % chktex 9
    \begin{align}
        \notag & S' = S \cup G \\
